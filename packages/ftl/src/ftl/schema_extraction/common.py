...
def extract_type(local_ctx: LocalExtractionContext, type_hint: Type[Any]) -> Optional[schemapb.Type]:
    ...
    if isinstance(type_hint, list):
        ...
        if type_hint is str or type_hint is int or type_hint is bool or type_hint is float:
...
def extract_slice(local_ctx: LocalExtractionContext, type_hint: List[Any]) -> Optional[schemapb.Type]:
...
def extract_map(local_ctx: LocalExtractionContext, type_hint: Dict[Any, Any]) -> Optional[schemapb.Type]:
